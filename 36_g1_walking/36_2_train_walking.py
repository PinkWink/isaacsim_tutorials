"""
36_2_train_walking.py - G1 휴머노이드 Walking(모션 모방) PPO 학습
...
실행:
    ...
    python 36_2_train_walking.py --headless

    # 환경 수 / 학습 반복 횟수 변경 (스모크 테스트)
    python 36_2_train_walking.py --headless --num_envs 64 --max_iterations 5
...
def main() -> None:
    ...
    print("  평가 실행: python 36_3_play_walking.py")
    print("=" * 70)
